...
class App(Frame):
    ...
    def initUI(self):
        self.parent.title("Kalkulator Sederhana by Fadhlih Hasan Setiawan")
    ...
    def errorMsg(self,msg):
        if msg == 'error':
            tkinter.messagebox.showerror('Galat!', 'Tejadi kesalahan! Mungkin Anda memasukkan bukan angka')
        elif msg == 'divisionerror':
            tkinter.messagebox.showerror('Terjadi kegagalan dalam perhitungan!', 'Anda memasukan angka 0 pada angka kedua. Tidak Bisa dibagi 0')
